...
matrix_walls_position_map=load_map_array_from_file(map_name='matrix_walls_map_first_level', file='matrix_walls_map_first_level.json')
...
def choose_window_generation(current_screen):
    match current_screen:
        ...
        case "training":
            ...
            return (current_screen_inside_choose_window_generation)
        case "first_level":
            print('generate_first_level(current_screen="first_level", player_position = player_position, last_player_position=last_player_position, matrix_walls_map=matrix_walls_position_map, matrix_player_vision_map=np.ones(map_height, map_width))')
...
def generate_about_game(current_screen):
    ...
    while running_about_game:
        ...
        pygame.display.flip()
def generate_training(current_screen="training", player_position = player_position, last_player_position=last_player_position, matrix_walls_map=matrix_walls_position_map):
    ...
    (current_player_position_map,
     ...
     matrix_walls_position_map,
     matrix_player_vision_map,
     matrix_decor_position_map,
     matrix_NPC_position_map) = level_layers_generate(map_width=map_width,
    ...
    while running_training:
        ...
        for event in pygame.event.get():
            ...
            Player.movement(matrix_walls_map, matrix_decor_position_map, matrix_NPC_position_map)
            ...
            if (running_E_training == 1):
                print_text(message="Чтобы открыть инвентарь, нажмите  E", x=training_text_location_x, y=training_text_location_y, font_color=WHITE)
                if keys[pygame.K_e]:
                    running_E_training = False
        ...
        pygame.display.flip()
        clock.tick(FPS)
def generate_first_level(current_screen = "first_level", player_position = player_position, last_player_position=last_player_position, matrix_walls_map=matrix_walls_position_map):
