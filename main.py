...
class Drawing:
    ...
    def draw_player(self, sc, player_pos, cur_player_pos):
        ...
        for x, y in cur_player_pos:
            screen.blit(player_avatar_image, (x - 2, y - 6))
    ...
    def draw_NPC(self, sc, cur_NPC_pos_map):
        for x, y in cur_NPC_pos_map:
            pygame.draw.circle(
                sc, RED, (x + TILE // 2, y + TILE // 2), TILE // 2)
            pygame.draw.circle(
                sc, BLACK, (x + TILE // 2, y + TILE // 2), TILE // 2, 2)
        ...
        for y in range (1,len(matrix_NPC_pos_map)+1):
            for x in range (1, len(matrix_NPC_pos_map[0])+1):
                if (matrix_NPC_pos_map[y-1][x-1]==7):
                    pygame.draw.circle(
                        sc, RED, (x*25 -( TILE // 2), y*25 - (TILE // 2)), TILE // 2)
                    pygame.draw.circle(
                        sc, BLACK, (x *25- (TILE // 2), y*25 - (TILE // 2)), TILE // 2, 2)
