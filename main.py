...
back_button.font = pygame.font.Font('Mediteran.ttf', 20)
...
def generate_pause(current_screen):
    ...
    paused = True
    while paused:
        screen.blit(pygame.image.load("pause.jpg"), (-100, 0))
...
background_image_to_pause = pygame.image.load("nemeron_gates.jpg")
...
health_bar = StatusBar(20, 20, 50, 20, 0, 50, current_value=Player.healthpoints, text = "HP", color = STATUS_BAR_HP_BACKGROUND_COLOR)
# Создаем отбражение атаки
damage_bar = StatusBar(20, 40, 50, 20, 0, 30, current_value=Player.damage, text = "Attack", color = STATUS_BAR_DAMAGE_BACKGROUND_COLOR)
# Создаем отбражение дальности зрения
vision_distance_bar  = StatusBar(20, 60, 50, 20, 0, 10, current_value=Player.vision_distance, text="vision", color =STATUS_BAR_VISION_BACKGROUND_COLOR)
