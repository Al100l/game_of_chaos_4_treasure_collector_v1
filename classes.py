...
class Hero:
    ...
    def movement(self, current_walls_map, current_decor_map, current_NPC_map):
        ...
        if keys[pygame.K_w]:  # north
            if current_walls_map[self.x - 1][self.y]==0 and current_NPC_map[self.x - 1][self.y]==0 and current_decor_map[self.x - 1][self.y]==0:
                self.x += -1
                self.y += 0
            ...
            if current_walls_map[self.x][self.y - 1]==0 and current_NPC_map[self.x][self.y - 1]==0 and current_decor_map[self.x][self.y - 1]==0:
                self.x += 0
                self.y += -1
